  ...
  routes: [
    { path: '/login', name: 'login', component: () => import('@/views/Login/index.vue') },
    {
      ...
      children: [
        ...
        { path: 'code-review-v2', name: 'code-review-v2', meta: { publicRead: true, title: '代码检视', lede: 'ReviewAgent 评审数据看板 · MR / 建议采纳率 / 规则命中 / 作者分布' }, component: () => import('@/views/CodeReviewV2/index.vue') },
