...
from app.api import auth, kb, diagnose, machines, notify, health, agents, settings as settings_api, pr_agent, review_agent
...
app.include_router(review_agent.router, prefix="/api/v1/review-agent", tags=["review-agent"])
